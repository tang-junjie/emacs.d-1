...
;;; base16-solarized-light-custom-theme.el

;;; Code:

(deftheme base16-solarized-light-custom)
...
(let ((base00 "#002b36")
  ...
  (custom-theme-set-faces
   'base16-solarized-light-custom

   ;; Built-in stuff (Emacs 23)
   `(border ((t (:background ,base03))))
   `(border-glyph ((t (nil))))
   `(cursor ((t (:background ,base01))))
   `(default ((t (:background ,base07 :foreground ,base01))))
   ...
   `(mode-line ((t (:background ,base05 :foreground ,base06 :box nil))))
   `(mode-line-buffer-id ((t (:foreground ,base00 :background nil))))
   ...
   ;; linum-mode
   `(linum ((t (:background ,base03 :foreground ,base05))))

   ;; Search
   `(match ((t (:foreground ,base0D :background ,base01 :inverse-video t))))
   `(isearch ((t (:foreground ,base08 :background ,base07 :inverse-video t))))
   ...
   ;; ace-window mode
   `(aw-leading-char-face ((((class color)) (:foreground ,base08))
                           (((background dark)) (:foreground ,base07))
                           (((background light)) (:foreground ,base00))
                           (t (:foreground "gray100" :underline nil))))
   `(avy-lead-face ((t (:foreground ,base07 :background ,base08))))
...
(provide-theme 'base16-solarized-light-custom)

;;; base16-solarized-light-custom-theme.el ends here
