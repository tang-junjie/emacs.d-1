...
;;; base16-eighties-dark-custom-theme.el

;;; Code:

(deftheme base16-eighties-dark-custom)
...
(let ((base00 "#2d2d2d")
  ...
  (custom-theme-set-faces
   ...
   `(outline-2 ((t (:foreground ,base08))))
   `(outline-3 ((t (:foreground ,base0E))))
   `(outline-4 ((t (:foreground ,base0A))))
   `(outline-5 ((t (:foreground ,base0B))))
   `(outline-6 ((t (:foreground ,base0F))))
   `(outline-7 ((t (:foreground ,base0C))))
...
(provide-theme 'base16-eighties-dark-custom)

;;; base16-eighties-dark-custom-theme.el ends here
